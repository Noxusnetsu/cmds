...
const fs = require("fs");
    ...
    const img = [" https://i.postimg.cc/HnSDLGVz/Kh-ng-C-Ti-u-45-20230629111058.png"]
	...
	return api.sendMessage({body: msg, attachment: imgP}, threadID, async (error, info) => {
		global.client.handleReply.push({
			name: this.config.name,
			bonus: bonus,
			messageID: info.messageID,
