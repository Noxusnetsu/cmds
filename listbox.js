...
module.exports.handleReply = async function({ api, event, args, Threads, handleReply }) {
  ...
  const time2 = moment.tz("Asia/Ho_Chi_minh").format("HH:MM:ss");
        ...
        case "reply":
            {
                if (arg[0] == "ban" || arg[0] == "Ban") {
                    ...
                    api.sendMessage({body:`=== [ 𝗕𝗔𝗡 𝗡𝗛𝗢́𝗠 ] ===\n🎀 𝗧𝗼̛́ 𝗻𝗵𝗮̣̂𝗻 𝗹𝗲̣̂𝗻𝗵 𝘁𝘂̛̀ 𝗮𝗱𝗺𝗶𝗻, 𝗬𝗲̂𝘂 𝗰𝗮̂̀𝘂 ban 𝗻𝗵𝗼́𝗺.\n𝗟𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗮𝗱𝗺𝗶𝗻 Đ𝗲̂̉ Đ𝘂̛𝗼̛̣𝗰 𝗴𝗼̛̃ 𝗯𝗮𝗻⏰Time: ${time2}`},idgr, () =>
                        api.sendMessage(`${global.data.botID}`, () =>
                            api.sendMessage(` [ 𝐌𝐎𝐃𝐄 ] - 𝗧𝗵𝘂̛̣𝗰 𝘁𝗵𝗶 𝗯𝗮𝗻\n ${msg}⏰Time: ${time2}`, threadID, () =>
                ...
                if (arg[0] == "unban" || arg[0] == "Unban" || arg[0] == "ub" || arg[0] == "Ub") {
                    ...
                    for (let num of nums) {
                      ...
                      api.sendMessage({body:`=== [ 𝑼𝑵𝑩𝑨𝑵 𝑩𝑶𝑿 ] ===\n🎀 Box Của Bạn Đã Được Gỡ Ban\n🐳Chúc Các Bạn Vui Vẻ\n⏰Time: ${time2}`},idgr, () =>
                        api.sendMessage(`${global.data.botID}`, () =>
                            api.sendMessage(` [ 𝐌𝐎𝐃𝐄 ] - 𝗧𝗵𝘂̛̣𝗰 𝗧𝗵𝗶 𝗨𝗻𝗕𝗮𝗻 ${msg}⏰Time: ${time2}`, threadID, () =>
                                api.unsendMessage(handleReply.messageID))));
                    break;
                }
...
module.exports.run = async function({ api, event, args }) {
  const permission = ["100062327635551"];
