...
const time = process.uptime(),
  ...
  const Canvas = require('canvas');
    ...
    let background = (await axios.get(encodeURI(`https://i.postimg.cc/X7kmy4ts/vip-20220630104405.png`), { responseType: "arraybuffer" })).data;
...
ctx.drawImage(l1, 20, -100, 700, 700);
    ...
    ctx.fillText("ANGEL BOT", 650, 150);
    ctx.beginPath();
  ////////////////////////////////////////
   registerFont(__dirname + `/tad/UTM-Avo.ttf`, {
    ...
    ctx.font = "70px UTM";
    ctx.fillStyle = "#ffffff";
    ctx.fillText(`${z_1} : ${x_1} : ${y_1} `, 650, 250);
    ctx.restore();
    ctx.save();
